...
# 	if TYPE_CHECKING:
# 		from erpnext.faculty_management.doctype.faculty_course_assignment.faculty_course_assignment import FacultyCourseAssignment
# 		from erpnext.faculty_management.doctype.faculty_employment_history.faculty_employment_history import FacultyEmploymentHistory
# 		from erpnext.faculty_management.doctype.faculty_performance_review.faculty_performance_review import FacultyPerformanceReview
# 		from erpnext.faculty_management.doctype.faculty_professional_development.faculty_professional_development import FacultyProfessionalDevelopment
# 		from erpnext.faculty_management.doctype.faculty_project_assignment.faculty_project_assignment import FacultyProjectAssignment
# 		from erpnext.faculty_management.doctype.faculty_qualification.faculty_qualification import FacultyQualification
# 		from frappe.types import DF

# 		address: DF.Link | None
# 		assigned_projects: DF.Table[FacultyProjectAssignment]
# 		availability_calendar: DF.Link | None
# 		bio: DF.TextEditor | None
# 		blood_group: DF.Literal["", "A+", "A-", "B+", "B-", "AB+", "AB-", "O+", "O-"]
# 		current_courses: DF.Table[FacultyCourseAssignment]
# 		date_of_birth: DF.Date | None
# 		date_of_joining: DF.Date
# 		department: DF.Link
# 		designation: DF.Link
# 		emergency_contract: DF.Data | None
# 		employee: DF.Link
# 		employment_history: DF.Table[FacultyEmploymentHistory]
# 		faculty_name: DF.Data | None
# 		gender: DF.Literal["", "Male", "Female", "Other"]
# 		max_weekly_hours: DF.Int
# 		mobile_no: DF.Data | None
# 		performance_reviews: DF.Table[FacultyPerformanceReview]
# 		personal_email: DF.Data | None
# 		professional_development: DF.Table[FacultyProfessionalDevelopment]
# 		quatifications: DF.Table[FacultyQualification]
# 		total_experience: DF.Float
