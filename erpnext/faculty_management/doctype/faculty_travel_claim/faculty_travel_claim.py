...
class FacultyTravelClaim(Document):
	...
	if TYPE_CHECKING:
		...
		from hrms.hr.doctype.travel_claim_advance.travel_claim_advance import TravelClaimAdvance
		from hrms.hr.doctype.travel_claim_item.travel_claim_item import TravelClaimItem

		advance_amount: DF.Currency
		advances: DF.Table[TravelClaimAdvance]
		...
		items: DF.Table[TravelClaimItem]
		journal_entry: DF.Data | None
		journal_entry_status: DF.Data | None
		miscellaneous_amount: DF.Currency
		miscellaneous_claim_reason: DF.SmallText | None
		mode_of_travel: DF.Literal["", "Office Car", "Personal Car", "Public Transport", "Flight"]
		net_amount: DF.Currency
		posting_date: DF.Date | None
		purpose_of_travel: DF.Link
		total_amount: DF.Currency
		travel_authorization: DF.Link | None
		travel_type: DF.Link
	...
	def get_advance(self):
		...
		Advance = frappe.qb.DocType("Faculty Travel Advance")
