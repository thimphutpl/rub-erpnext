...
class FacultyTravelAuthorization(Document):
	...
	if TYPE_CHECKING:
		...
		from hrms.hr.doctype.travel_authorization_item.travel_authorization_item import TravelAuthorizationItem
		...
		items: DF.Table[TravelAuthorizationItem]
		mode_of_travel: DF.Literal["", "Office Car", "Personal Car", "Public Transport", "Flight"]
		need_advance: DF.Check
		posting_date: DF.Date
		purpose_of_travel: DF.Link
		reports_to: DF.Link | None
		reports_to_name: DF.Data | None
		status: DF.Literal["Draft", "Submitted", "Claimed", "Cancelled"]
