...
frappe.ui.form.on('Case Tracking System', {
	...
	onload: function(frm) {
		...
		frm.set_query("loan_product", function() {
			return {
				query: "erpnext.legal.doctype.court_tracking_system.court_tracking_system.get_loan_product",
		...
		frm.set_query("case_description", "case_status", function (frm, cdt, cdn) {
			...
			return {
				...
				// ]
				query: "erpnext.legal.doctype.court_tracking_system.court_tracking_system.get_case_description_options",
                filters: {
