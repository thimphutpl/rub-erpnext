...
// 					cost_center.toggle(false);
// 					var project = frappe.query_report.get_filter("project"); 
// 					project.toggle(true);
// 					var group_by_account = frappe.query_report.get_filter("group_by_account"); 
// 					group_by_account.toggle(false);
// 					var controllable = frappe.query_report.get_filter("controllable"); 
// 					controllable.toggle(false);	
// 					var budget_type = frappe.query_report.get_filter("budget_type"); 
// 					budget_type.toggle(false);	
// 				}else{
// 					var cost_center = frappe.query_report.get_filter("cost_center"); 
// 					cost_center.toggle(true);
// 					var project = frappe.query_report.get_filter("project"); 
// 					project.toggle(false);	
// 					var group_by_account = frappe.query_report.get_filter("group_by_account"); 
// 					group_by_account.toggle(true);
// 					var controllable = frappe.query_report.get_filter("controllable"); 
// 					controllable.toggle(true);
// 					var budget_type = frappe.query_report.get_filter("budget_type"); 
// 					budget_type.toggle(true);			
// 				}
// 				query_report.trigger_refresh();	
// 			},
// 			"reqd":1,
