...
def get_data(filters=None):
    ...
    if filters.get("operation_type"):
        conditions.append("hca.operation_type = %(operation_type)s")
    ...
    query = f"""
        SELECT
            ...
            hca.operation_type as request_type
...
def get_columns():    
    return [
        ...
        {"label": "Operation Type", "fieldname": "request_type", "fieldtype": "Data", "width": 120},
