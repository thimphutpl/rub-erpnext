...
class eNote(Document):
	...
	if TYPE_CHECKING:
		from education.academic_management.doctype.note_remark.note_remark import NoteRemark
		from erpnext.enote.doctype.enote_note_copy.enote_note_copy import EnoteNoteCopy
		...
		copied: DF.TableMultiSelect[EnoteNoteCopy]
