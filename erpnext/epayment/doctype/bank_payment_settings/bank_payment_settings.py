...
class BankPaymentSettings(Document):
	...
	if TYPE_CHECKING:
		...
		acknowledgement_path: DF.Data | None
		company_specific_code: DF.Int
		connection_type: DF.Literal["", "Normal", "Key file"]
		day_txn_file_name: DF.Data | None
		enable_one_to_one: DF.Check
		financial_institution: DF.Link
		from_time: DF.Time | None
		hostname: DF.Data
		password: DF.Password | None
		paying_customer: DF.Data
		port: DF.Int
		private_key_path: DF.Data | None
		promo_code: DF.Data
		report_path: DF.Data | None
		to_time: DF.Time | None
		transaction_limit: DF.Int
